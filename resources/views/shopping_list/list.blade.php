...
@foreach ($list as $task)
        <tr>
            ...
            <td><form style="margin: 0" style="text-align: center" action="{{ route('delete', ['shopping_list_id' => $task->id]) }}" method="post"> @csrf  @method("DELETE")　<button onclick='return confirm("この「買うもの」を「削除」します。よろしいですか？");' >削除</button></form>
